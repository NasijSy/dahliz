...
<Head title="القائمة السوداء" />
<main class="flex-1">
    <div class="flex flex-col items-center justify-center text-center my-16 px-2" dir="rtl">
        <h2 class="text-4xl text-red-500 font-black mb-4">القائمة السوداء</h2>
        <p>يعتمد التصنيف على سلوك الحسابات  من خلال ترويجها لمحتوى مضلل أو تحريضي بشكل ممنهج</p>
        {#snippet note()}
